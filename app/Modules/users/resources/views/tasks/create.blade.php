    ...
    <div class="d-flex align-items-center flex-wrap mr-1">
        ...
        <div class="d-flex align-items-baseline flex-wrap mr-5">
            ...
            <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                ...
                <li class="breadcrumb-item text-muted">
                    <a class="text-muted">@lang('users.Users Tasks')</a>
                </li>
                <li class="breadcrumb-item text-muted">
                    <a href="" class="text-muted">@lang('users.Create New Task')</a>
                </li>
            </ul>
            <!--end::Breadcrumb-->
        </div>
...
@section('content')
    <div class="row">
        <div class="col-lg-12 ">
            {!! Form::open(['route' => 'tasks.store', "class"=>"kt-form", 'id'=> 'kt_form', 'enctype'=>"multipart/form-data"]) !!}
